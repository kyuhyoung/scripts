...
sudo docker run --gpus all -ti --shm-size 8G --rm -e DISPLAY=$DISPLAY -e="QT_X11_NO_MITSHM=1" --device /dev/video0 -v /dev/video0:/dev/video0 -v /tmp/.X11-unix:/tmp/.X11-unix:ro -v $3:/mnt/$dir_shared $1:$2
