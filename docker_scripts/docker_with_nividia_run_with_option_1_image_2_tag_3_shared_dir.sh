...
sudo docker run --gpus all -ti --shm-size 8G --rm --net=host -e DISPLAY=$DISPLAY --device /dev/video0 -v /tmp/.X11-unix -v /dev/video0:/dev/video0 -v $3:/mnt/$dir_shared $1:$2 bash
